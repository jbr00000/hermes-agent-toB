...
class CLICommandsMixin:
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        """Report that CLI-to-messaging-platform handoff was removed."""
        from cli import _cprint

        _cprint("  /handoff is disabled in the to-B build.")
        _cprint("  Use the enterprise API/front-end task handoff flow instead.")
        return True
