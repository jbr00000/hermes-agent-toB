...
def _pause_windows_gateways_for_update() -> dict | None:
    """No-op: the messaging gateway service is removed in the to-B fork."""
    return None
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        # Messaging gateway restart hooks were removed in the to-B fork.
        _resume_windows_gateways_after_update(_windows_gateway_resume)

        # Kill stale dashboard processes        # Kill stale dashboard processes — the dashboard has no service
...
def cmd_pairing(args):
    print("hermes pairing has been removed in this to-B fork.")
